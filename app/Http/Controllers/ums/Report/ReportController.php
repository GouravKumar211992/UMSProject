...
class ReportController extends Controller
{
  ...
  public function applicationReportList(Request $request)
  {
    ...
    return view('ums.report.application-report-list', [
      'page_title' => "Campuse",
      'sub_title' => "records",
  ...
  public function mbbsBscNursingReport(Request $request)
  {
    ...
    return view('ums.report.mbbs_bsc_nursing_exam_report', compact('academic_session', 'form_type', 'get_allowed_student_data'));
  }

...
use App\Http\Controllers\ums\Controller;
...
class EntranceExamScheduleController extends Controller
{
   ...
   {    
    ...
    return view('ums.admissions.entrance_exam_schedule', ['entranceExamData' => $entranceExamData]);
   }
    ...
    public function edit($id)
   {
     ...
     return view('ums.admissions.entrance-exam-schedule',['info'=>$data]);
   }

...
class AdmitCardController extends AdminController
{
	...
	$subjects = $subjects->sortByDesc('date_order');
				//dd($subjects);
				return view('student.admitcard.mbbs-admitcard-page', [
            'page_title' => "Admit Card",
            'sub_title' => "records",
            'examfee' => $examfee,
            'subjects' => $subjects,
        ...
        return view('student.admitcard.admitcardview', [
            'page_title' => "Admit Card",
            'sub_title' => "records",
            'examfee' => $examfee,
            'subjects' => $subjects,

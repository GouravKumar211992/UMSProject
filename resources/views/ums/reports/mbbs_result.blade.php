        ...
        <div class="content-wrapper container-xxl p-0">
            <div class="content-header row">
                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Mbbs Result</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="content-header-right text-sm-end col-md-7 mb-50 mb-sm-0">
                    ...
                    {{-- <a class="btn btn-dark btn-sm mb-50 mb-sm-0" href="#"><i data-feather="file-text"></i>Bulk Result</a>  --}}
              ...
              <button class="btn btn-dark  btn-sm mb-50 mb-sm-0 " onclick="bulk_result()"><i data-feather="file-text"></i>Bulk Result</button>
                    </div>
                </div>
            </div>
...
<script>
// bulk_result
function bulk_result() {

window.location.href = "bulk_result"; 
}
</script>

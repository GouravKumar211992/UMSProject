            ...
            <div class="content-header row">
                <div class="content-header-left col-md-6 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Disability Report </h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                                    <li class="breadcrumb-item active">(DR)</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row align-items-center mb-1">
                                ...
                                <div class="col-md-3" >
                                    <button type="submit" class="btn btn-primary btn-sm mb-50 mb-sm-0 w-100">
                                        <span class="d-inline"><i data-feather="check-circle" ></i>Get Report</span>
                                    </button>
                                </div>
                            </div>
                        </div>

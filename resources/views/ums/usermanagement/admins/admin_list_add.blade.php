            ...
            <div class="content-header pocreate-sticky">
				<div class="row">
					...
					<div class="content-header-right text-sm-end col-md-6 mb-50 mb-sm-0">
                        <form action="/user/submit-user-form" method="post">
                            @csrf
						<div class="form-group breadcrumb-right">   
							...
							<button type="submit" class="btn btn-primary btn-sm mb-50 mb-sm-0"><i data-feather="check-circle"></i>Publish</button> 
						</div>
					</div>
				</div>
			</div>

            ...
            <div class="content-header row">
                ...
                <div class="content-header-right text-sm-end col-md-7 mb-50 mb-sm-0">
                    <div class="form-group breadcrumb-right">
                        <a class="btn btn-dark btn-sm mb-50 mb-sm-0" href="{{ url('email-template-add') }}"><i
                                data-feather="file-text"></i>Add Email Template</a>
                                            ...
                                            @foreach ($all_users as $key => $user)
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><span
                                                                class="badge rounded-pill badge-light-{{ strtolower($user->status) == 'active' ? 'success' : 'danger' }}">{{ ucfirst($user->status) }}</span>
                                                        </td>

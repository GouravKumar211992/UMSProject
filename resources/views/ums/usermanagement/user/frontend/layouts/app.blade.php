            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.status == true) {
                        ...
                        $.each(data, function(index, val) {
                            $this.closest('#myform').find('.' + index + '_login').text(val).css({
                                'display': 'block'
                            });
                        });
                        $this.closest('#myform').find('.login_login').html(data.message).css({
                            'display': 'block'
                        });
                    }
                },
                error: function(request, status, error) {
                    $this.closest('#myform').find('.login_login').text(error).css({
                        'display': 'block'
                    });
                }
            });
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.status == true) {
                        ...
                        $.each(data, function(index, val) {
                            $('.' + index + '_forgot').text(val).css({
                                'display': 'block'
                            });
                        });
                        $('.forgot_forgot').text(data.message).css({
                            'display': 'block'
                        });
                    }
                },
                error: function(request, status, error) {
                    $('.forgot_forgot').text(error).css({
                        'display': 'block'
                    });
                }
            });

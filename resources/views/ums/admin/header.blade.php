...
<head>
    ...
    <style>
        ...
        #myModal .modal-dialog {
            width: 90%; /* Set to desired width percentage, e.g., 80% */
            max-width: 1200px; /* You can set a maximum width as well */
        }
    
        /* Set fixed height and make the content scrollable if it overflows */
        #myModal .modal-content {
            height: 90vh; /* Set to desired height, e.g., 80% of viewport height */
            overflow-y: auto; 
            overflow-x: hidden
        }

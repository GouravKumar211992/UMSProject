...
{{-- <body class="vertical-layout vertical-menu-modern navbar-floating footer-static menu-collapsed" data-open="click" data-menu="vertical-menu-modern" data-col=""> --}}
    ...
    <div class="tittle text-center pb-2">
        DR. SHAKUNTALA MISRA NATIONAL REHABILITATION UNIVERSITY, LUCKNOW <br>
        EXAMINATION RESULT, JAN-2024<br>
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="table-responsive">
                                        ...
                                        <div class="examner d-flex justify-content-between align-items-center p-2 mb-5">
                                            <p >
                                                P=PASSED, PCP=PROMOTED WITH CARRYOVER PAPERS, A=ABSENT, LG=LETTER GRADE, QP=QUALITY POINT, <br> SGPA=SEMESTER GRADE POINT AVERAGE, WH=WITHHELD
                                            </p>
                                            <p >

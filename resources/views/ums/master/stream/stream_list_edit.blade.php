    ...
    <div class="app-content content ">
            ...
            <div class="content-header row">
                ...
                <div class="content-header-right text-sm-end col-md-7 mb-50 mb-sm-0">
                    <div class="form-group breadcrumb-right">
                        <button type="submit" form="edit_stream_form" onclick="javascript: history.go(-1)" class=" btn btn-primary btn-sm mb-50 mb-sm-0 waves-effect waves-float waves-light "><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check-circle"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg> Update</button>
        ...
        <div class="row align-items-center mb-1">
            ...
            <div class="col-md-4 mb-3">
                <div class="d-flex align-items-center">
                    ...
                    <input type="text" class="form-control" name="stream_name"  value="{{$selected_stream->name}}" >
            ...
            <div class="col-md-4 d-flex align-items-center">
                ...
                <select name="color_code" aria-controls="DataTables_Table_0" class="form-select">
            ...
            <div class="col-md-4 d-flex align-items-center">
                ...
                <select name="DataTables_Table_0_length" name="category_id" aria-controls="DataTables_Table_0" class="form-select">
        ...
        <div class="row align-items-center mb-1">
            <div class="col-md-4 d-flex align-items-center">
                ...
                <select name="DataTables_Table_0_length" name="university" aria-controls="DataTables_Table_0" class="form-select">

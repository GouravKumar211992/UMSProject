            ...
            <div class="content-header row">
                ...
                <div class="content-header-right text-sm-end col-md-7 mb-50 mb-sm-0">
                    <div class="form-group breadcrumb-right">
                        <a class="btn btn-dark btn-sm mb-50 mb-sm-0" href="add_question_bank"><i
                                data-feather="file-text"></i> Add Question Bank </a>
                        <button class="btn btn-primary btn-sm mb-50 mb-sm-0" data-bs-target="#filter"
                            data-bs-toggle="modal"><i data-feather="filter"></i> Filter</button>
                        <button class="btn btn-warning box-shadow-2 btn-sm  mb-sm-0 mb-50"><i
                                    ...
                                    <table class="datatables-basic table myrequesttablecbox loanapplicationlist">
                                        ...
                                        @if (count($quesBankData) > 0)
                                            ...
                                            @foreach ($quesBankData as $key => $internal)
                                                ...
                                                <td>{{ optional($internal->Semester)->name ?? 'N/A' }}</td>
                                                <td>{{ optional($internal->subject)->name ?? 'N/A' }}</td>
                                                <td>{{ $internal->session }}</td>
                                                        <td><a href="{{ $internal->question_bank_file }}"
                                                                target="_blank">Download</a></td>
                                                        <td><a href="{{ $internal->synopsis_file }}"
                                                                target="_blank">Download</a></td>
                                                        <td><a href="{{ $internal->thysis_file }}"
                                                                target="_blank">Download</a></td>
                                                        <td><a href="{{ $internal->journal_paper_file }}"
                                                                target="_blank">Download</a></td>

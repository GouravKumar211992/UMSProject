                                ...
                                <div class="table-responsive">
                                        <table class="datatables-basic table myrequesttablecbox loanapplicationlist">
                                            <thead>
                                                <tr>
                                                    <div class="row">
                                                    <th class="col-md-2">Notification Description</th>
                                                    <th class="col-md-3">Notification Started</th>
                                                    <th class="col-md-7">Notification Ended</th>
                                                </div>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>motifincation</td>
                                                    <td class="fw-bolder text-dark">2025-01-23</td>
                                                    <td >2025-01-24</td>

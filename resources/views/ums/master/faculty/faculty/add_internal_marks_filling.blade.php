...
<body class="vertical-layout vertical-menu-modern navbar-floating footer-static menu-collapsed" data-open="click"
    ...
    <div class="app-content content ">
        ...
        <div class="content-wrapper container-xxl p-0">
            ...
            <form method="get" name="internal_form" action="{{ route('internal-marks') }}" onsubmit="return validateForm()">
                @csrf
                        ...
                        <div class="row align-items-center mb-1">
                            ...
                            <div class="col-md-9">
                                <select id="semester" name="semester" class="form-control">
                                    <option value="">--Select Sem--</option>@if($mapped_Semesters)
		  @foreach($mapped_Semesters as $index=>$mapped_Semester)
			 ...
			 @endif
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row align-items-center mb-1">
                            ...
                            <div class="col-md-9">
                              <input type="text" placeholder="Enter here" {{($mapped_faculty)?$mapped_faculty->campus->name:''}} class="form-control">
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 ">
                        ...
                        <div class="row align-items-center mb-1">
                            ...
                            <div class="col-md-9">
                              <input type="date" class="form-control" placeholder="Enter here"  name="date_of_semester" value="{{$date_of_semester}}" required>
                            </div>
                        </div>
                 ...
                 <div class="col-md-6">
                    ...
                    <div class="row align-items-center mb-1">
                        ...
                        <div class="col-md-9">
                         <input  id="sub_name" name="sub_name"  class="form-control" value="{{$sub_code_name}}" disabled required/>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 ">
                        ...
                        <input type="text" hidden name="campus_name" value="{{$mapped_faculty->Course->Campuse->name}}">
            ...
            <script>$(document).ready(function() {
                // When the course is changed, fetch the semesters
                $('#course').change(function() {
                    var courseId = $(this).val();  // Get selected course ID
                    if (courseId) {
                        $.ajax({
                            url: "{{ url('faculty/getsemester') }}",  // Ensure this URL matches the route
                            method: 'POST',
                            data: {
                                course: courseId,
                            ...
                            success: function(response) {
                                // Replace the options in the #semester dropdown with the new ones
                        ...
                        $('#semester').html('<option value="">--Select Semester--</option>'); // Reset semester options if no course is selected
                    }
                });
            });
        </script>

    ...
    <div class="container-fluid">
		...
		<div class="row mb-3">
            <div class="col-sm-12">
				...
				<a href="{{route('internal-marks')}}"  class="btn-md btn-add"><i class="iconly-boldPlus"></i> Add Internal Mark</a>
				<a href="{{route('internal-marks-show')}}"  class="btn-md btn-success"><i class="iconly-boldPlus"></i> Show Internal Mark</a>

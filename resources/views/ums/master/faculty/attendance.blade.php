            ...
            <div class="content-header row">
                <div class="content-header-left col-md-5 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h3 class="content-header-title float-start mb-0">Student's Lecture Attendance</h3>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/">Home</a></li>  
                                    <li class="breadcrumb-item active">Showing Attendance</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="content-header-right text-sm-end col-md-7 mb-50 mb-sm-0">
                    <div class="form-group breadcrumb-right"> 
                        ...
                        <a class="btn  btn-dark  btn-sm mb-50 mb-sm-0" href="{{ url('admin_list_add') }}">
                            <i data-feather="user-plus"></i> Add Attendance
                        </a>  
                        <a class="btn  btn-dark  btn-sm mb-50 mb-sm-0" href="{{ url('show_Attendance') }}">
                            <i data-feather="user-plus"></i> Show Attendance
                        </a>  

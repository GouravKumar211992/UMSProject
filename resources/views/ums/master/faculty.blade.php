            ...
            <div class="content-header row">
                <div class="content-header-left col-md-5 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Faculty</h2>
                ...
                <div class="content-header-right text-sm-end col-md-7 mb-50 mb-sm-0">
                    <div class="form-group breadcrumb-right"> 
                      <a class="btn btn-dark btn-sm mb-50 mb-sm-0" href="{{url('faculty_add')}}"><i data-feather="file-text"></i> Add Faculty </a>
                                        ...
                                        <table class="datatables-basic table myrequesttablecbox loanapplicationlist">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>IFSC Code</th>
                                                    <th>Research Paper Type</th>
                                                    <th>Number Of Research Paper</th>
                                                    <th>Action</th>
                                            ...
                                            {{-- <tbody>
                                                ...
                                                <tr>
                                                    <td>#1</td>
                                                    <td class="fw-bolder text-dark">ABHIJEET KUMAR</td>
                                                    <td>BED.SE.HI</td>
                                                    <td>other</td> 
                                                    <td>satyanarayan Prasad Singh</td> 
                                                    <td>abhijeetkr.1v@gmail.com</td> 
                                                    <td>7004264707</td> 
                                                    <td>1988-01-28</td> 
                                                    <td>male</td> 
                                                    <td>married</td> 
                                                    ...
                                                    <td class="tableactionnew">  
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                ...
                                                                <a class="dropdown-item" href="{{url('faculty_edit')}}" >
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div style="width: 200px;">
                                                                    <a href="{{ url('secret-login', $item->id) }}" target="_blank"

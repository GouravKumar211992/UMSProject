    ...
    <div class="app-content content ">
      ...
      <div class="content-header row">
            ...
            <div class="content-header-right text-sm-end col-md-7 mb-50 mb-sm-0">
                <div class="form-group breadcrumb-right">
                    ...
                    <button class="btn btn-warning btn-sm mb-50 mb-sm-0" onclick="window.location.reload();" ><i data-feather="refresh-cw"></i>
                        Reset</button> 
                        <button form="add-semesterfee-form" class="btn btn-primary btn-sm mb-50 mb-sm-0" > <i data-feather="check-circle" style="font-size: 40px;"></i>
                        Submit</button>
                </div>
            </div>
        </div>
        ...
        <section class="col-md-12 connectedSortable">
            <form id="add-semesterfee-form" action="{{url('add_semesterfee')}}">
                @csrf
            <div class="row">
                <!-- Student ID Input -->
                <div class="col-md-4">
